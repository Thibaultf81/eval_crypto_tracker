...
def homepage():
    ...
    with open("wallet_crypto.json", "r") as f:
...
def buyPage():
    ...
    if request.method == 'POST':
        ...
        # On indique que quantity doit être supérieur à 0
        if quantity > 0:
            ...
            if crypto in wallet_crypto.keys():
                ...
                wallet_crypto[crypto]['total_price'] += round(total_price, 2)
    ...
    with open("wallet_crypto.json", "w") as f:
